...
d2 = Distance(2, "km")
print(d1 + d2)                      # 5.00 km
print(Distance(3, "km") == Distance(3, "km"))   # True
print(sorted([Distance(5, "km"), Distance(1, "km"), Distance(3, "km")]))

# --- WP-201 + WP-206: one loop, mixed types including a duck-typed FakeTrail ---
mixed = [
...
print(mixed[3].summary())   # shows the "extends, doesn't replace" summary

# --- WP-201: proving the abstract base class can't be instantiated ---
try:
